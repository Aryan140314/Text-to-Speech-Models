"""
CosyVoice 3 — Benchmarking runner delegate.
...
def generate_cosyvoice_speech(text: str, ref_audio_path: str, output_path: str) -> dict:
    """
    Generate speech using CosyVoice 3 backend via the unified synthesis pipeline.
