"""
Chatterbox Turbo — Benchmarking runner delegate.
...
def generate_chatterbox_speech(text: str, ref_audio_path: str, output_path: str) -> dict:
    """
    Generate speech using Chatterbox Turbo backend via the unified synthesis pipeline.
