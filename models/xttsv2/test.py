"""
XTTS-v2 — Benchmarking runner delegate.
...
def generate_xttsv2_speech(text: str, ref_audio_path: str, output_path: str) -> dict:
    """
    Generate speech using XTTS-v2 backend via the unified synthesis pipeline.
